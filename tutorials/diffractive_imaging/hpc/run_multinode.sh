...
WORKDIR=/global/u2/a/armccray/quantem-tutorials/tutorials/diffractive_imaging/multi_node/             # CHANGE: working directory on scratch
CONDA_ENV=/global/common/software/m5020/armccray/conda/quantem  # CHANGE: path to your conda env
PTYCHO_INPUT=$WORKDIR/ptycho_1gpu.zip
PTYCHO_OUTPUT=$WORKDIR/ptycho_multinode_result.zip
PTYCHO_ITERS=2000
PTYCHO_LR_OBJ=5e-2
PTYCHO_LR_PROBE=5e-2
PTYCHO_BATCH_SIZE=256                        # global batch size (split across all ranks automatically)
